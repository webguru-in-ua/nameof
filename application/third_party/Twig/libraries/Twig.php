...
class Twig
{
    ...
    public function __construct($template)
    {
        ...
        $this->CI->config->load('twig'); // load config file
        ...
        $this->templates = array(APPPATH.'views/'.$this->layout_dir);

        // load environment
        $this->_loader = new Twig_Loader_Filesystem(APPPATH.'views/'.$this->layout_dir, $this->cache_dir);


        $this->_twig_env = new Twig_Environment($this->_loader, array(
    ...
    public function set_layout($layout = 'default'){
        $this->_loader->setPaths(array(APPPATH.'views/'.$layout));
    }
    ...
    public function display($template, $data = array())
    {
        ...
        $data['elapsed_time'] = $this->CI->benchmark->elapsed_time('total_execution_time_start', 'total_execution_time_end').' sec';
    ...
    public function ci_function_init()
    {
        ...
        $this->_twig_env->addFunction('validation_errors', new Twig_Function_Function('validation_errors'));
        $this->_twig_env->addFunction('lang', new Twig_Function_Function('lang'));

        $this->_twig_env->addFunction('thumbnailByURL', new Twig_Function_Function('thumbnailByURL'));

        $this->_twig_env->addFunction('character_limiter', new Twig_Function_Function('character_limiter'));
    }
}
